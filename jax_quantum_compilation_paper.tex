...
\begin{itemize}
    \item \textbf{Baseline (Sequential):} 68.03 seconds.
    \item \textbf{JAX Parallel Pipeline:} 13.55 seconds.
\end{itemize}
This represents a \textbf{5.02x speedup}, demonstrating that the system is limited only by physical core count and XLA compilation throughput.
